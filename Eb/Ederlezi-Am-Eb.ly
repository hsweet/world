...
primos = \relative c'' {
  ...
  \repeat volta 2{
    \mark \default
    r4 fs8 g a (g)fs (e)
    e8 fs~fs4    e4 d %g16 f g8 f4
     r4 d8 e e4 e8 cs|
    d4. e8 cs4 b %e16 d e8 d4|
...
secund = \relative c'' {
  ...
  \repeat volta 2{
    \mark \default
    r4 d8 e fs e d cs
    cs8 d~d4 cs4 b%e16 d e8 d4|
        r4 fs8 g g4 g8 e|
    fs4. g8 e4 d%g16 f g8 f4|
...
\score {
  <<
    ...
    \new Staff
    \transpose b fs' \primos
    \new Staff \transpose b fs' \secund
