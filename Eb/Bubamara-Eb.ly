...
melody =  \relative c'' {
  ...
  \repeat volta 2{
    ...
    r8 g4 e8 cis4 g'
    fis8 fis4 d8 b4 r4|
    r8 cis4 cis8 d cis bis cis

  }

  \alternative {
    {fis4 g fis2 }
    {r8 fis4 g8 fis _rit e d cis }
  }


  \repeat volta 2{
    b8 ^\markup { \box B} cis d e fis eis fis4

    r8 b4 g8 e4 r4
    r8 fis4 d8 b4 r4
    e8 d cis b ais b cis d
    b2. r4|
